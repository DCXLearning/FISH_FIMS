...
ui <- fluidPage(
  ...
  div(id = "sidebarPanel", class = "sidebar",
      ...
      # selectInput("quarter", "Select Quarter", choices = c("All", "Q1", "Q2", "Q3", "Q4")),
      selectInput("province", "Select Province", choices = province_choices), # Replace with your province_choices
